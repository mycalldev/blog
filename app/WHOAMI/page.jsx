  ...
  return (
    <div className={styles.containerMain}>
      ...
      <div className={styles.imageHeroContainer}>
            <Image src={"/linux_parrot.jpg"} width={1024} height={1024} className={styles.imageHero} alt='linux parrot' quality={100} />
      </div>
      <div className={styles.imageWhoamiContainer}>
          <Image src={'/whoami_terminal.png'} width={890} height={100} className={styles.imageWhoami} alt="whoami image" quality={100} />
      </div>

      <div className={styles.titleMain}>WHOAMI</div>
      <div className={styles.tagLine}> My Journey As a Computer Programmer: 7+ Years of Building Digital Worlds</div>
      
      <div className={styles.contentMainAdditioanl}>Welcome tech enthusiasts! I go by the alias <span>Mycall Dev</span> and I'm excited to share my journey as a computer programmer with you today. With over <span>7</span> years in the field, I've had the opportunity to delve into various facets of technology, gaining expertise in Networking, Cyber Security, Linux, and Full Stack Development.</div>
      ...
      <div className={styles.contentMainAdditioanl}>I enjoy Learning and Teaching and thereby Learning.... With all my Projects, I initiate a <span>'Performance First Approach'.</span> </div>

      
      <div className={styles.imagePerformanceContainer}>
           <Image src={"/performance_whoami.jpg"} width={1528} height={891} className={styles.imagePerformance} />
      </div>
      <div className={styles.contentMainAdditioanl}>Alongside the Technologies (mentioned above), The greatest skill set I posses is the ability to fastrack my develpmont and the understanding of a construct or concept I am otherwise unfamiliar with....</div>
      <div className={styles.contentMainBold}>For Example:</div>
      <div className={styles.contentMainAdditioanl}> <span>A new programming launguage.</span></div> 
      <div className={styles.contentMainAdditioanl}>I carry this out utilising the resources of today's modern world (internet, books, podcasts, AI) and a formula for learing I have developed (see link at the bottom of the page).</div>
      <div className={styles.contentMainAdditioanl}>In other words, I can reach Point 'A' to Point 'B' expeditiously and with accuracy. I firmly believe this is owed to the nature of me being self taught (in part) and learning to be comfortable with the uncomfortable i.e being calculatd in the state of not knowing and having the experience over the years of understanding that all that is unknown is there to be discovered.</div>
      
      <div className={styles.titleSub}>My Journey</div>
     
      <div className={styles.contentMainAdditioanl}>I started off with a Windows 95 PC at the age of 11 (with the old skool dial up modems and AOL). By 12 years old I began studying HTML, a little CCS and a cracked version of Photoshop. After a year of messing around in chat rooms and learning how the internet worked I moved on to creating music via programmes such as: </div>
      <ul className={styles.ulContainer}>
      ...
      <div className={styles.contentMainAdditioanl}>Created a few tracks and Mastered a few Dub-Plates by the age of 15. At the same time I was an MC (Microphone Controller/Rapper) on several pirate radio staions and performing at night clubs with an age restriction of over 18 whilst only being 16 years old.  </div>
      <div className={styles.contentMainAdditioanl}>Prior to this - during my school era - I was center stage performing (rapping) with the Royal Philharmonic Orchestra in front of a full capacity audience at the Royal Festival Hall. I was well accustomed by now to perform in front of big crowds and went on to rap at several large venues.</div>
      
      <div className={styles.microphoneImageContainer}>
            <Image src={"/microphone.jpg"} width={500} height={500} />
      </div>
      
      <div className={styles.contentMainAdditioanl}>At the age of 16 I was selected for a Football Academy that required training 3 times a week and College twice a week. I choose Mucic Technology as my subject and carried on with musical performances at the college and several other theaters. During my College days a friend of mine and myself started to promote events at particualr nightclubs. This opened my eyes up to the Marketing world (before Social Media). Designing billboard posters, promotional flyers, tickets.... etc. The promotional events were a success, having carried out the first event at the age of 17 - and the event having an age policy of being over 18s only.... lol.... </div>
      <div className={styles.contentMainAdditioanl}>For several reasons I decided to pick up a Trade and became a builder. Eventually, all my time was allocated to the building work and the Technological side of my mind took a back seat. I started a successful business in the building trade and worked up until my 30s. However, something just didn't feel right and my attention to detail and fastidious nature, along with that voice in your head, kept telling me to return to Technology.</div>
      ...
      <div className={styles.performanceImageContainer}>
            <Image src={"/dolphin.jpg"} width={1024} height={1024} />
      </div>

      <div className={styles.contentMainAdditioanl}>The journey from here on out was not smooth to say the least. Although, through discipline, tenacity, and a great support network - in terms of colleagues and family - I have been privileged to follow my passion.    </div>
      <div className={styles.titleSub}>Moving Forward</div>
     
      <div className={styles.contentMainAdditioanl}>I picked up from where I left off in my early adolescence; first re engaging with HTML and CSS. Thereafter, I studied python for a brief period and then made a progressive move to join a very unique Bootcamp: </div> 
      <div className={styles.contentMainAdditioanl}> (Construstor Labs - https://constructorlabs.com/)</div> 
      <div className={styles.imageConstructorLabsContainer}>
       <Image src={'/constructor.png'} width={399} height={366} quality={100} alt={'constructor labs logo'} />
      </div>
      <div className={styles.contentMainAdditioanl}> I say unique because it was set out differently from all of the other mainstream Bootcamps. The sole intention of Constructor Labs and the head of Teaching (Dmitri Brabov) was to teach Javascript (vanilla), React, Redux, Node, PostgreSQL and Git/Github all in the space of 12 weeks. And this was a near insurmountable task. Although, hats off to Dmitri; he pulled it off, and his teaching style was with very little hand holding. </div>
      <div className={styles.contentMainAdditioanl}>With the benefit of hindsight I can now see that Dmitri was no time waster and his teaching style was such that if you were meant to be a computer programmer then you needed to work things out for yourself.</div> 
      ...
      <Link href={'/learnTolearn'}>
            <div className={styles.letsGoBTN}>Learn To Learn</div>
      </Link>
